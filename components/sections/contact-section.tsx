                        ...
                        <LiquidGlass className="p-6 md:p-8 relative">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-r from-primary to-[hsl(var(--electric-cyan))] opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
